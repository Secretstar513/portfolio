    ...
    <div className='project-window' id = {props.id}>
      <div className={`project-wrapper ${props.className}`}>
        <div className="about-project">
          ...
          <button className='btn' onClick={handleOnClick}><span>View on<FiExternalLink className="social" size={20} style={{ marginLeft: "8px", position: "relative", top: "2px", strokeWidth: "3" }}/></span></button>
        </div>
